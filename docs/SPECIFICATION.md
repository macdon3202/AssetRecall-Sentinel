# AssetRecall Sentinel V1 specification

## Boundary and proof obligation

V1 determines whether an official NHTSA recall for an exactly decoded US-market vehicle semantically covers a sealed component/risk scope. It does not certify ownership, mechanical condition, repair completion, insurance eligibility, or legal liability.
